        ...
        <div class="row">
            <div class="card bg-dark justify-content-center align-items-center" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush text">
                    ...
                    <li class="list-group-item">Email: Claire@icloud.com</li>
            ...
            <div class="card bg-dark justify-content-center align-items-center" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush text">
                    ...
                    <li class="list-group-item">Email: michelle@icloud.com</li>
                    <li class="list-group-item">GitHub: michelle55</li>
                </ul>
            </div>
            <div class="card bg-dark justify-content-center align-items-center" style="width: 18rem;">
                <div class="col card-header">
                ...
                <ul class="list-group list-group-flush text">
                    ...
                    <li class="list-group-item">Email: david@icloud.com</li>
            ...
            <div class="card bg-dark justify-content-center align-items-center" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush text">
                    ...
                    <li class="list-group-item">Email: hayden@icloud.com</li>
                    <li class="list-group-item">School: GW</li>
                </ul>
            </div>
        </div>
